...
class ObjectViewController extends Controller
{
    ...
    /**
     * @Route(path="/{_project}/{beamName}/{name}/{tableViewName}/{id}/objectview/create", name="pa_objectview_create")
     * @ParamConverter("beam", class="Beam")
     * @ParamConverter("objectDefinition", class="ObjectDefinition", options={"objectDefinitionName" = "name"})
     */
    public function createAction(Request $request, Beam $beam, $name, $id, ObjectDefinition $objectDefinition, $tableViewName)
    {
    ...
    /**
     * @Route(path="/{_project}/{beamName}/{name}/{tableViewName}/{id}/objectview/{viewName}/edit", name="pa_objectview_edit")
     * @ParamConverter("beam", class="Beam")
     * @ParamConverter("objectDefinition", class="ObjectDefinition", options={"objectDefinitionName" = "name"})
     */
    public function editAction(Request $request, Beam $beam, $name, $id, ObjectDefinition $objectDefinition, $viewName, $tableViewName)
    {
        $this->assertGranted('ROLE_PA_VIEW_EDIT');
    ...
    /**
     * @Route(path="/{_project}/{beamName}/{name}/{tableViewName}/{id}/objectview/{viewName}/delete", name="pa_objectview_delete")
     * @ParamConverter("beam", class="Beam")
     * @ParamConverter("objectDefinition", class="ObjectDefinition", options={"objectDefinitionName" = "name"})
     */
    public function deleteAction(Beam $beam, $name, $id, ObjectDefinition $objectDefinition, $viewName, $tableViewName)
    {
        $this->assertGranted('ROLE_PA_VIEW_EDIT');
