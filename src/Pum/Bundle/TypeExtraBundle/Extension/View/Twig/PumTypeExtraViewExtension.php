...
class PumTypeExtraViewExtension extends \Twig_Extension
{
    ...
    public function getFunctions()
    {
        return array(
            ...
            new \Twig_SimpleFunction('pum_media_url', function ($media, $width = 0, $height = 0) {
                return $this->view->getMediaUrl($media, $width, $height);
            }),
            new \Twig_SimpleFunction('pum_media_url_by_id', function ($id, $isImage, $width = 0, $height = 0) {
                return $this->view->getMediaUrlById($id, $isImage, $width, $height);
            }),
        );
    }
}
